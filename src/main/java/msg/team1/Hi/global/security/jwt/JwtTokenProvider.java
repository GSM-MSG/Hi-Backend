...
import msg.team1.Hi.global.security.authentication.UserDetailsServiceImpl;
...
public class JwtTokenProvider {
    ...
    public String generateToken(UserDetailsImpl userDetails) {
        ...
        val isAdmin = userDetails.getAuthorities().stream().anyMatch(a ->
                a.getAuthority().equals("ROLE_"+ Role.ADMIN));
